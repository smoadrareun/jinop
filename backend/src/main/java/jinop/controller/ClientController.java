...
public class ClientController {
    ...
    @RequestMapping(value = "/quecli",produces = "application/json;charset=utf-8")
    ...
    @RequestMapping(value = "/addcli", produces = "application/json;charset=utf-8")
    ...
    @RequestMapping(value = "/delcli/{id}", produces = "application/json;charset=utf-8")
    ...
    @RequestMapping(value = "/editcli", produces = "application/json;charset=utf-8")
    ...
    @RequestMapping(value = "/showcli",produces = "application/json;charset=utf-8")
    ...
    @RequestMapping(value = "/findcli",produces = "application/json;charset=utf-8")

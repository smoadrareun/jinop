...
public class CommodityController {
    ...
    @RequestMapping(value = "/addcom", produces = "application/json;charset=utf-8")
    ...
    @RequestMapping(value = "/delcom/{id}", produces = "application/json;charset=utf-8")
    ...
    @RequestMapping(value = "/editcom", produces = "application/json;charset=utf-8")
    ...
    @RequestMapping(value = "/showcom",produces = "application/json;charset=utf-8")
    ...
    @RequestMapping(value = "/findcom",produces = "application/json;charset=utf-8")

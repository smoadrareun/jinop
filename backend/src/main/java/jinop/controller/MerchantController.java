...
public class MerchantController {
    ...
    @RequestMapping(value = "/quemer",produces = "application/json;charset=utf-8")
    ...
    @RequestMapping(value = "/addmer", produces = "application/json;charset=utf-8")
    ...
    @RequestMapping(value = "/delmer/{id}", produces = "application/json;charset=utf-8")
    ...
    @RequestMapping(value = "/editmer", produces = "application/json;charset=utf-8")
    ...
    @RequestMapping(value = "/showmer",produces = "application/json;charset=utf-8")
    ...
    @RequestMapping(value = "/findmer",produces = "application/json;charset=utf-8")
